...
function fmtTournamentDate(iso) {
  if (!iso) return ''
    ...
    <section id="torneos" className="torneos" ref={ref}>
      ...
      <div className="container">
        <div className="torneos__inner">
          ...
          {/* Banner del torneo activo — solo si hay torneo open */}
          {active && (
            <Link to="/torneo" className="reveal torneos__banner">
              ...
              <span className="torneos__banner-fecha">
                ...
                {fmtTournamentDate(active.tournament_date)}
              </span>
              ...
              <>
                ...
                <div className="torneos__cta-secondary">
                  <a href="/legal/bases-torneo-slots.html" target="_blank" rel="noopener noreferrer" className="torneos__bases-link">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                    Ver bases y condiciones del torneo
                  </a>
                  <span className="torneos__cta-sep">·</span>
                  <a href="https://www.instagram.com/salajuegoscrespo/" target="_blank" rel="noopener noreferrer" className="torneos__bases-link">
